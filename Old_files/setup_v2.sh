...
echo "[Note] * i2c-tools"
echo ""
echo "[Note] Initial Workspace Setup:"
echo "[Note] * Workspace 1: Visual Studio Code"
echo "[Note] * Workspace 2: Files & Terminator"
echo ""
...
echo "[Note] * git"
echo ""
echo "[Note] Application Installation:"
echo "[Note] * arduino"
#echo "[Note] * energia"
echo "[Note] * vscode"
echo "[Note] * eclipse"
...
echo "[Note] * nomachine"
echo ""
echo "[Note] ROS Installation:"
echo "[Note] * ROS 2 Jazzy - Ubuntu Noble 24.04"
echo ""
...
echo "[System Aliases]"
  ...
  sh -c "echo \"# System shortcut\" >> ~/.bashrc"
  ...
  sh -c "echo \"# Git shorcut\" >> ~/.bashrc"
  sh -c "echo \"alias ga='git add'\" >> ~/.bashrc"
  sh -c "echo \"alias gs='git status'\" >> ~/.bashrc"
  sh -c "echo \"alias gp='git pull'\" >> ~/.bashrc"
  sh -c "echo \"\" >> ~/.bashrc"

  sh -c "echo \"# My Git shorcut\" >> ~/.bashrc"
...
ask_and_run "Run system setting" system_setup
ask_and_run "Run system installation?" system_install
ask_and_run "Run workspace setup?" workspace_setup
ask_and_run "Run system alias?" system_alias
ask_and_run "Run application installation?" app_install
ask_and_run "Run ROS installation?" ros2_jazzy_install
