...
sh -c "echo \"alias ros2ws='cd ~/\\\$NAME_ROS2_WORKSPACE'\" >> ~/.bashrc"s
sh -c "echo \"alias ros2src='cd ~/\\\$NAME_ROS2_WORKSPACE/src'\" >> ~/.bashrc"
sh -c "echo \"alias ros2lib='cd ~/\\\$NAME_ROS2_WORKSPACE/src/libraries'\" >> ~/.bashrc"
sh -c "echo \"alias ros2tut='cd ~/\\\$NAME_ROS2_WORKSPACE/src/tutorials'\" >> ~/.bashrc"
sh -c "echo \"alias ros2proj='cd ~/\\\$NAME_ROS2_WORKSPACE/src/projects'\" >> ~/.bashrc"
sh -c "echo \"alias colconb='cd ~/\\\$NAME_ROS2_WORKSPACE && colcon build'\" >> ~/.bashrc"
sh -c "echo \"alias colconbs='cd ~/\\\$NAME_ROS2_WORKSPACE && colcon build --select-package'\" >> ~/.bashrc"
sh -c "echo \"alias ros2ls='source ~/\\\$NAME_ROS2_WORKSPACE/install/local_setup.bash'\" >> ~/.bashrc"
sh -c "echo \" \" >> ~/.bashrc"
